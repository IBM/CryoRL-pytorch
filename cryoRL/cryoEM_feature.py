...
class CryoEMFeature:
    def __init__(self, cryoEM_data, hist_bins, ctf_low_thresh, prediction):
...
class CTFValueFeature(CryoEMFeature):
    def __init__(self, cryoEM_data, hist_bins=[0, 4, 6, 8, 10, 999999], ctf_low_thresh=CryoEMConfig.LOW_CTF_THRESH, prediction=True):
